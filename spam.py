...
if __name__=="__main__":
    try:
          ...
          8.[Spam Sms] Olx
          9.[Spam Sms] Matahari
          10.[Spam Sms] Sociolla
          11.[Spam Sms] Herokuapp
          12.[Spam Sms] Indomaret
          """)
          jns=input("pilih jenis spam: ")
          c=no[1:12]
          w=hh+c
          kata("Program Spam Berjalan....!!\nKlik Ctrl+C untuk Stop")
          if jns == "1":
              while True:
                  jenius()
                  time.sleep(2)
          ...
          sys.exit("\rSpam Di Berhentikan")
    except requests.exceptions.ConnectionError:
          sys.exit('Cek Koneksi!')
    except TypeError:
          balik()
    except ValueError:
          balik()

# udah sampai bawah su recode nya?
# tukang recode anjing
